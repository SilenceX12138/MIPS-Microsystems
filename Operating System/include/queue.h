 ...
 * head is head-pointer(LIST_HEAD) structure's POINTER
 */
...
// step 3: Assign listelm.next to the address of elm.
// step 4: Assign elm.pre to a the address of listelm.next's pointer.
 ...
 */
// step1:initialize a var to tranverse list
// step2:check whether the list is empty
// step3:if not empty, tranverse and insert
// step4:if empty,take elm as the first elm of list
//       REMEMBER to assign elm.prev to the address of head
#define LIST_INSERT_TAIL(head, elm, field)                                                 \
        ...
        {                                                                                  \
                ...
                {                                                                          \
                        LIST_FOREACH(loopvar, head, field)                                 \
                        {                                                                  \
                                if (loopvar->field.le_next == NULL)                        \
                                {                                                          \
                                        (elm)->field.le_prev = &LIST_NEXT(loopvar, field); \
                                        loopvar->field.le_next = (elm);                    \
                                        break;                                             \
                                }                                                          \
                        }                                                                  \
                }                                                                          \
...
#define LIST_NEXT(elm, field) ((elm)->field.le_next) // return pointer of next elem
